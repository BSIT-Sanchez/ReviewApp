  ...
  return (
    <Layout>
      <div className="grid md:grid-cols-4 grid-cols-1 justify-items-center gap-4 mb-[4rem]">
       {/* Left Side */}
        <div className="col-span-1 flex flex-col justify-center items-center pl-10">
        <h1 className="text-[72px] font-extrabold text-center text-[#FF5900] leading-[1] mt-[4rem]">
            Get In Touch.
        </h1>
        ...
        <div className="col-span-3 bg-[#ece7e7] border border-[#A33900] p-8 rounded-lg shadow-lg mt-[4rem] w-[70%]">
